...
function Bar() {
  const barQuery = useTypesafeQuery(barTypesafeRoute); //you will get type barQuery: { name: string; age?: number; }
  // you will get type:
  // const navigateToFoo: (query: {name: string; age?: number; }) => void
